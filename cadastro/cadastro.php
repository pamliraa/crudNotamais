        ...
        <div id="form">
            ...
            <form action="cadastrar.php" method = "POST">
                ...
                <div class="icon-input">
                    ...
                    <input type="text" name="nome" id="nome" class="input" placeholder="Ex: Ana">
                </div>
                ...
                <div class="icon-input">
                    ...
                    <input type="text" name="email" id= "email" class="input" placeholder="Ex: ana@gmail.com">
                </div>
                ...
                <div class="icon-input">
                    ...
                    <input type="password" name="senha" id="senha"  class="input" placeholder="Ex: 123">
                </div>
